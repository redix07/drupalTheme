...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes.' node-'.$view_mode; ?> clearfix "<?php print $attributes; ?>>
  ...
  <?php elseif ($view_mode == 'full'): ?>
    ...
    <div class="clearfix bottom-navi">
      ...
      <a class="back-link read-more-butt" href="<?php print base_path().$_url_array[$language->language];?>" ><div class="read-more-lab"><?php print t ('back');?></div>« <?php print t('Thematic proposals'); ?></a>
